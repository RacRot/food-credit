...
function LoginController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (user) {
            ...
            bcrypt.compare(password, user.passwordHash, (_, pswIsValid) => {
                if (!pswIsValid) {
...
function RegisterNewUserController(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const pswHash = yield bcrypt.hash(password, salt);
        //generate and save user
        new User({ email: email, passwordHash: pswHash, username: username }).save((err, newUser) => {
            if (err) {
